...
const address = value => {
  if (value.length < 3 || value.length > 20) {
    return (
      <div className="alert alert-danger" role="alert">
        The address must be between 3 and 20 characters.
      </div>
    );
  }
};
...
const sni = value => {
  if (value.length !== 8) {
    return (
      <div className="alert alert-danger" role="alert">
        The address must be 8 characters.
      </div>
    );
  }
};
...
export default class Register extends Component {
  constructor(props) {
    ...
    this.onChangeSni = this.onChangeSni.bind(this);
              ...
              <div>
                ...
                <div className="form-group">
                  ...
                  <Input
                    ...
                    onChange={this.onChangeSni}
                    validations={[required, sni]}
                  />
                </div>
